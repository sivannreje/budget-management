...
class AddExpense(budget_management.base_handler.BaseHandler):
    async def post(self):
        ...
        print(f"inserting expense={item}")
        insert_result = await self._data_access_layer.insert_one('expenses', item)
